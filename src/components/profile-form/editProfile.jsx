...
import {addProfile} from "../../store/actions/profile.action";
import {getCurrentProfile} from "../../store/actions/profile.action";

const EditProfile = ({profile: {profile, loading}, getCurrentProfile, addProfile, history}) => {
    ...
    const [displaySocialField, toggleSocialField] = useState(true)
    ...
    useEffect(() => {
        ...
        setFormData({
            ...
            skills: loading && profile.skills.length === 0 ? '' : profile.skills.join(','),
    ...
    const toggle = () => {
        toggleSocialField(!displaySocialField);
    }
...
export default connect(mapStateToProps, {addProfile, getCurrentProfile})(withRouter(EditProfile));
