...
const CreateProfile = ({addProfile, history}) => {
    ...
    const [displaySocialField, toggleSocialField] = useState(false)
...
export default connect(null, {addProfile})(withRouter(CreateProfile));
